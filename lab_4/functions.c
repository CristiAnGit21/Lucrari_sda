 ...
 */
Node **store_BST_in_array(const BinaryTree *tree, const int nodes_count) {
    int index = 0;
    Node **array_of_nodes = malloc(sizeof(Node *) * nodes_count);
 ...
 */
Node *convert_array_to_BST(Node **nodes, const int start, const int end) {
    if (start > end) {
        return NULL;
    }
